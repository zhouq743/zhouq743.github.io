...
$('#open-instruction').one('click',function(){
    ...
    $(this).removeClass('add-gradient');
    $(this).addClass('move-up');
    $(this).css('top','6.5vw');
    $('#instruction').delay(1000).fadeIn(2000);
    $('#start-button').delay(1000).fadeIn(2000);
});   


//start the game
$('#start-button').click(function(){
    $('#open-instruction').removeClass('move-up');
    $('#open-instruction').addClass('move-down');
    setTimeout(function(){
        ...
        setTimeout(function(){
            ...
            $('#open-instruction').removeClass('move-down')
...
$('.parts').click(function(){
    $('#open-instruction').appendTo('body');
    $('#open-instruction').removeClass('moving-ball');
    $('#open-instruction').css('top','calc(50vh - 3vw)');
    $('#open-instruction').addClass('move-down2');
    setTimeout(function(){
        $('#open-instruction').css('cursor','pointer');
        $('#open-instruction').removeClass('move-down2');
        $('#open-instruction').css('top','calc(7vw + 50vh)');
        $('#open-instruction').css('z-index','1')
        setTimeout(function(){
    ...
    $('#open-instruction').addClass('submit-button');
...
$('#input-question').keyup(function(){
    ...
    var prope = document.querySelector('#submit').disabled;
    console.log(prope);
});
$('form').submit(function(event){
    ...
    $('#submit').delay(2100).fadeOut(2000);
    $('#submit').prop('disabled',true);
    $('#submit').appendTo('body');
    $('#submit').addClass('move-down3');
    $('#submit').css('top','calc(90vh - 3vw)');
    $('#submit').css('left','94%');
...
function showItems() {
    items.forEach((item) => {
        ...
        var desContainer = document.createElement('p');
